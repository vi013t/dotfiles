...
sudo pacman -S coreutils wireless_tools picom flameshot feh xorg-xinput brightnessctl pamixer ffmpeg ripgrep wezterm firefox nemo discord neovim spotify-launcher
